    ...
    <div>
      ...
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
        <h1 className='text-slate-700 font-bold text-3xl lg:text-6xl'>
          List your <span className='text-slate-500'>Car</span>
          <br />
          with ease
        </h1>
        <div className='text-gray-500 text-lg font-semibold sm:text-sm'>
          CarsManager - The evolution of your dreams.
          <br />
          Find and list the drive of your life.
        </div>
        <Link
          to={'/search'}
          className='text-xs sm:text-sm text-slate-500 font-bold hover:underline'
        >
          Let's get started...
        </Link>
      </div>
